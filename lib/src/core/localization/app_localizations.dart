...
abstract class AppLocalizations {
  ...
  /// No description provided for @noEbooksMessage.
  ///
  /// In en, this message translates to:
  /// **'No ebooks yet. Tap + to add one.'**
  String get noEbooksMessage;

  /// No description provided for @addingBookMessage.
  ///
  /// In en, this message translates to:
  /// **'Adding book...'**
  String get addingBookMessage;
  ...
  /// No description provided for @chapterIndicator.
  ///
  /// In en, this message translates to:
