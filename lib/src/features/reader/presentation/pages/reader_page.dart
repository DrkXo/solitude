                             ...
                             child: Stack(
                               children: [
                                 PageView.builder(
                                   ...
                                   scrollDirection: settingsState.appSettings.behavior.navigationMethod == NavigationMethod.swipeVertical ? Axis.vertical : Axis.horizontal,
                                   physics: (settingsState.appSettings.behavior.navigationMethod == NavigationMethod.swipeHorizontal || settingsState.appSettings.behavior.navigationMethod == NavigationMethod.swipeVertical) ? null : NeverScrollableScrollPhysics(),
                                   ...
                                   itemBuilder: (context, index) => ReaderContent(
                                     ...
                                     onToggleBars: () => setState(() => _showBars = !_showBars),
                                     onTapDown: (details) {
                                       if (settingsState.appSettings.behavior.navigationMethod == NavigationMethod.tap) {
                                         ...
                                         if (tapX < screenWidth * 0.3) {
                                           ...
                                           if (action == 'previousPage' && index > 0) {
                                             context.read<ReaderBloc>().add(const ReaderEvent.previousChapter());
                                           }
                                         } else if (tapX > screenWidth * 0.7) {
                                           // Right zone
                                           final action = settingsState.appSettings.behavior.tapZones.right;
                                           if (action == 'nextPage' && index < controller.totalChapters - 1) {
                                             context.read<ReaderBloc>().add(const ReaderEvent.nextChapter());
                                           }
                                         } else {
                                           // Center zone
                                     ...
                                     onHorizontalDragEnd: settingsState.appSettings.behavior.navigationMethod == NavigationMethod.swipeHorizontal ? (details) {
                                     ...
                                     onVerticalDragEnd: settingsState.appSettings.behavior.navigationMethod == NavigationMethod.swipeVertical ? (details) {
                                   ...
                                   onPageChanged: (page) {
                                     context.read<ReaderBloc>().add(ReaderEvent.updateReadingProgress(page));
                                   },
                                 ),
                                 ReaderTopBar(
                                   showBars: _showBars,
