...
return footerMarginBottomChanged(_that);case _HtmlRenderingModeChanged() when htmlRenderingModeChanged != null:
return htmlRenderingModeChanged(_that);case _ReadingDirectionChanged() when readingDirectionChanged != null:
...
return footerMarginBottomChanged(_that);case _HtmlRenderingModeChanged():
return htmlRenderingModeChanged(_that);case _ReadingDirectionChanged():
...
return footerMarginBottomChanged(_that.margin);case _HtmlRenderingModeChanged() when htmlRenderingModeChanged != null:
return htmlRenderingModeChanged(_that.mode);case _ReadingDirectionChanged() when readingDirectionChanged != null:
...
return footerMarginBottomChanged(_that.margin);case _HtmlRenderingModeChanged():
return htmlRenderingModeChanged(_that.mode);case _ReadingDirectionChanged():
...
class _HtmlRenderingModeChanged implements SettingsEvent {
  const _HtmlRenderingModeChanged(this.mode);
  

 final  HtmlRenderingMode mode;

/// Create a copy of SettingsEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$HtmlRenderingModeChangedCopyWith<_HtmlRenderingModeChanged> get copyWith => __$HtmlRenderingModeChangedCopyWithImpl<_HtmlRenderingModeChanged>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HtmlRenderingModeChanged&&(identical(other.mode, mode) || other.mode == mode));
}
...
@override
String toString() {
  return 'SettingsEvent.htmlRenderingModeChanged(mode: $mode)';
}
...
/// @nodoc
abstract mixin class _$HtmlRenderingModeChangedCopyWith<$Res> implements $SettingsEventCopyWith<$Res> {
  factory _$HtmlRenderingModeChangedCopyWith(_HtmlRenderingModeChanged value, $Res Function(_HtmlRenderingModeChanged) _then) = __$HtmlRenderingModeChangedCopyWithImpl;
@useResult
$Res call({
 HtmlRenderingMode mode
});
...
/// @nodoc
class __$HtmlRenderingModeChangedCopyWithImpl<$Res>
    implements _$HtmlRenderingModeChangedCopyWith<$Res> {
  __$HtmlRenderingModeChangedCopyWithImpl(this._self, this._then);

  final _HtmlRenderingModeChanged _self;
  final $Res Function(_HtmlRenderingModeChanged) _then;

/// Create a copy of SettingsEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? mode = null,}) {
  return _then(_HtmlRenderingModeChanged(
null == mode ? _self.mode : mode // ignore: cast_nullable_to_non_nullable
as HtmlRenderingMode,
  ));
}
