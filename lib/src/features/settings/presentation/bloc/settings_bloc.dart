  ...
  SettingsBloc(
    ...
    on<SettingsEvent>((event, emit) async {
      await event.map(
        ...
        pageLayoutChanged: (e) => _updateSetting(() => _appSettingsService.setPageLayout(e.pageLayout), emit),
        readingDirectionChanged: (e) => _updateSetting(() => _appSettingsService.setReadingDirection(e.readingDirection), emit),
        scrollModeChanged: (e) => _updateSetting(() => _appSettingsService.setScrollMode(e.scrollMode), emit),
