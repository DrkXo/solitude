             ...
             builder: (context, settingsState) {
               return state.maybeWhen(
                 loaded: (ebooks, isAdding) =>
                     _buildLoaded(context, ebooks, isAdding, settingsState.appSettings.library),
                 loading: () => const Center(child: CircularProgressIndicator()),
                 error: (message, ebooks) => _buildLoaded(context, ebooks, false, settingsState.appSettings.library),
  ...
  Widget _buildLoaded(
     ...
     sortedEbooks.sort((a, b) {
       switch (librarySettings.sortBy) {
         ...
         case 'last_read':
           ...
           return bLastRead.compareTo(aLastRead); // Most recent first
         default:
           return a.ebook.metadata.title.compareTo(b.ebook.metadata.title);
       }
     });
    ...
    return Column(
      children: [
         ...
         Expanded(
           child: librarySettings.viewStyle == 'list'
               ? ListView.builder(
